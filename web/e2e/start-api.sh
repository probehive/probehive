...
PROBEHIVE_ENVIRONMENT=Development \
  ...
  PROBEHIVE_OUTBOUND_ALLOWED_CIDRS=127.0.0.0/8 \
  PROBEHIVE_OUTBOUND_ALLOWED_PORTS=5080 \
  PROBEHIVE_WEBHOOK_KEYRING=e2e:AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA \
  "$API_BINARY" &
API_PID=$!
wait "$API_PID"
