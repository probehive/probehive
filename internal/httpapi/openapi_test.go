...
func TestOpenAPIDocumentDescribesEveryRoute(t *testing.T) {
	...
	expected := map[string][]string{
		...
		"/api/v1/organizations/{organizationId}/incidents": {"get"},
		...
		"/api/v1/organizations/{organizationId}/projects/{projectId}/monitors/{monitorId}/maintenance-windows":                              {"get", "post"},
		"/api/v1/organizations/{organizationId}/projects/{projectId}/monitors/{monitorId}/maintenance-windows/{maintenanceWindowId}":        {"get"},
		"/api/v1/organizations/{organizationId}/projects/{projectId}/monitors/{monitorId}/maintenance-windows/{maintenanceWindowId}/cancel": {"post"},
...
func TestOpenAPIDocumentLocksValidationBoundaries(t *testing.T) {
	...
	for _, name := range []string{
		...
		"IncidentInboxPageResponse", "IncidentInboxItemResponse", "IncidentInboxIncidentResponse",
		"IncidentInboxMonitorResponse", "IncidentInboxHealthResponse",
		"IncidentInboxMaintenanceResponse", "IncidentInboxRunResponse",
